...
pref("extensions.dta.filters.deffilter1.test", "/\\.(?:z(?:ip|[0-9]{2})|r(?:ar|[0-9]{2})|jar|bz2|gz|tar|rpm)$/i");
...
pref("extensions.dta.filters.deffilter2.test", "/\\.(?:mpeg|rm|mpe|avi|mpg|mp4|mov|divx|asf|qt|wmv|ram|m1v|m2v|rv|vob|asx)$/i");
...
pref("extensions.dta.filters.deffilter3.test", "/\\.(?:jp(?:e?g|e|2)|gif|png|tif|tiff|bmp|ico)$/i");
...
pref("extensions.dta.filters.deffilter4.test", "/\\.(?:exe|msi|dmg|bin|xpi)$/i");
...
pref("extensions.dta.filters.deffilter5.test", "/\\.jp(e?g|e|2)$/i");
