 ...
 * License.
 *
 * The Original Code is DownThemAll GlobalBucket module.
 *
...
const EXPORTED_SYMBOLS = ["ByteBucket", "ByteBucketTee", "GlobalBucket"];
...
addObserver("extensions.dta.speedlimit", Observer);
