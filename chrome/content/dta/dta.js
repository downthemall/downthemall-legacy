			...
			var itemNode = document.createElement("treeitem");
				...
				var treeRow = document.createElement("treerow");
					...
					var url = document.createElement("treecell");
						url.setAttribute("label", " " + (links[i].url.usable ? links[i].url.usable : links[i].url));
						url.setAttribute("value", i);
						
						updateIcon(links[i].url.url?links[i].url.url:links[i].url, url);
